...
## 🟢 Win case สด (tenant-type enum, repo go-live) — กลไก "ทางที่ดีกว่า" ทำงานจริง
...
failure mode ที่ tenant-type enum เปิดโปง: **claim แบบครอบคลุม** ("path หลักครอบแล้ว / ครบทุก
