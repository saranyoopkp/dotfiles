...
check claude/rules/core/change-control.md "Reversibility gate"
...
check claude/rules/core/change-control.md "ห้ามลดระดับเพียงเพื่อหลีกเลี่ยงการถาม"
...
check claude/rules/engineering/documentation-discipline.md "ค้น assertion ซ้ำใน workspace/root/sibling"
