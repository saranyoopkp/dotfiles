...
7. Report the answer, source paths/URLs and revision/date, probes and actual results, conflicts, unknowns and the
   next decision SCC must make.

Scout output is a lead for SCC to verify against primary evidence, not authorization or acceptance by itself.
