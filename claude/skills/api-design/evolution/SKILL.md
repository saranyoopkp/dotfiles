...
- OpenAPI/schema, generated client, docs และ contract tests ต้องเปลี่ยนร่วมกับ implementation; rollout/feature flag อยู่ `compatibility-rollout` ตาม owner เดิม
